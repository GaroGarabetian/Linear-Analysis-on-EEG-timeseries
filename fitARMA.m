function [nrmseV,phiV,thetaV,SDz,aicS,fpeS,armamodel,xpreM]=fitARMA(xV,p,q,Tmax)
% [nrmseV,phiV,thetaV,SDz,aicS,fpeS,armamodel,xpreM]=fitARMA(xV,p,q,Tmax)
...
%               nrmseV)
%  xpreM   : the matrix of Tmax columns, where each T column is the vector 
%            of estimated the T-time step ahead in-sample-predicted values. 
